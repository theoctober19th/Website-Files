...
if (!function_exists('anna_lite_product_format_function')) {

	function anna_lite_product_format_function() {
		...
		if ( anna_lite_postmeta( '_sale_price' ) ) :	
	...
	add_action( 'anna_lite_product_format', 'anna_lite_product_format_function' );
